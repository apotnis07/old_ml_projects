...
while loop:
    ...
    if ch==1:
      ...
      print("1.For entering text to file")
      print("2.For calculations")
      print("3.For exiting the current option")
     ...
     AUDIO_FILE = ("C:/Users/Admin/PycharmProjects/aneesh/3add.wav")
